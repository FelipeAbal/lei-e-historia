...
O documento sintetizou as ideias do contratualismo lockeano — direitos naturais, governo por consentimento, direito de resistência — e as transformou em norma jurídica positiva pela primeira vez. Sua linguagem e estrutura tornaram-se o modelo canônico do constitucionalismo de direitos.`
    ...
    },
    {
      ...
      title: 'Sobre o Texto',
      type: 'text',
      content: `A tradução apresentada é baseada na versão portuguesa amplamente utilizada em ambientes acadêmicos, cotejada com o texto inglês original (*Virginia Declaration of Rights*) aprovado pela Convenção de Virgínia em 12 de junho de 1776. O documento original foi redigido principalmente por George Mason (1725–1792), com contribuições de James Madison, que expandiu as garantias de liberdade religiosa no Artigo 16º.

O texto tem importância dupla na história do direito. Primeiro, como precursor direto: Thomas Jefferson o consultou ao redigir a Declaração de Independência dos EUA (julho de 1776), e o Marquês de Lafayette o utilizou como modelo ao trabalhar na Declaração dos Direitos do Homem e do Cidadão francesa (1789). Segundo, como antecedente da Bill of Rights norte-americana: James Madison, ao redigir os dez primeiros aditamentos à Constituição dos EUA (1791), retomou sistematicamente os artigos da Declaração de Virgínia.

O Artigo 16º merece atenção especial: o rascunho original de Mason previa apenas "tolerância" religiosa — um conceito que pressupõe que o Estado concede uma permissão revogável. Madison substituiu o termo por "livre exercício da religião", antecipando o princípio da separação entre Igreja e Estado que seria consagrado na Primeira Emenda da Constituição americana.`
    }
  ]
};
