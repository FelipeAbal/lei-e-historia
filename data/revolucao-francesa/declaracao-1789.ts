...
Por consequência, a Assembleia Nacional reconhece e declara, na presença e sob os auspícios do Ser Supremo, os seguintes direitos do Homem e do Cidadão:`
    ...
    },
    {
      ...
      title: 'Sobre o Texto',
      type: 'text',
      content: `A tradução apresentada é baseada na versão em língua portuguesa amplamente utilizada em ambientes académicos e jurídicos de países lusófonos, cotejada com o texto original em francês (*Déclaration des droits de l'Homme et du citoyen*). O documento original foi aprovado pela Assembleia Nacional em 26 de agosto de 1789 e tornou-se parte integrante do bloco de constitucionalidade francês, sendo hoje considerado norma de valor constitucional pela jurisprudência do Conselho Constitucional.
